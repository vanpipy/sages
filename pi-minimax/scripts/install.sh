#!/usr/bin/env bash
#
# ~/Project/sages/pi-minimax/scripts/install.sh
#
# Deploy pi-minimax from source to runtime (~/.pi/packages/minimax)
# Mirrors pi-yunxiao install.sh pattern: selective cp -r + settings.json registration
#
# Usage:
...
# Decision C (mirror pi-yunxiao): scripts NOT copied to runtime
