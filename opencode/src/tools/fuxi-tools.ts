 ...
 * ║                                                                           ║
 * ║   Tools for Fuxi (伏羲) - Architect using MDD Seven Planes                 ║
...
export const fuxi_create_draft = tool({
  description: `Fuxi creates an architectural design draft following the MDD Seven Planes structure.

MDD Seven Planes (八卦) mapping:
