...
/** The pi-orchestrator package root: <pkg>/ in the installed copy, the
 *  pi-orchestrator/ directory in the source tree. Resolves module-relative
 *  so we never depend on cwd, $HOME, or any machine-specific path.
 *  File lives at pi-orchestrator/src/template-loader.ts → up 1 = package root. */
