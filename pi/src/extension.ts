 ...
 *
 * Subagents (`developer`, `software-auditor`) are NOT registered
 ...
 * 4-stage pipeline (Explore → Plan → developer → software-auditor).
 *
 ...
 * `developer` subagent via the Agent tool for production code.
 */
